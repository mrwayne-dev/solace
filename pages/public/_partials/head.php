...
// Usage:
//   $page_title       (string)  e.g. "TitanXHoldings — Build Wealth"
//   $page_description (string)
//   $page_path        (string)  e.g. "/about" (for canonical)
// ============================================================
$page_title       = $page_title       ?? 'TitanXHoldings';
$page_description = $page_description ?? 'FCA-authorised investment platform — high-yield savings, fractional shares, automated investing, all in one regulated wallet.';
$page_path        = $page_path        ?? '/';
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="canonical" href="https://titanxholdings.com<?= htmlspecialchars($page_path) ?>">
