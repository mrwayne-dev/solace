...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="HealthRunCare Admin - HoldLock Savings">
    <meta name="author" content="HealthRunCare">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="robots" content="noindex, nofollow">
    <title>HealthRunCare Admin - HoldLock Savings</title>
    ...
    <div id="page" class="">
        <div class="layout-wrap loader-off">
                    ...
                    <div class="center">
                        ...
                        <div class="center-item">
                            <ul>
                                ...
                                <!-- FUND MANAGEMENT - HOLDLOCK ACTIVE -->
                                <li class="menu-item has-children active">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item active"><a href="/admin.funds/holdlock"><div class="text">Holdlock</div></a></li>
            ...
            <div class="section-content-right">
                            ...
                            <div class="tf-container">
                                ...
                                <div class="row mb-32">
                                    <div class="col-12">
                                        <div class="wallet-cards grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap20">
                                            <!-- Total HoldLock Balance -->
                                            <div class="wallet-card wallet-main">
                                                <div class="wallet-card-header">Total HoldLock Balance</div>
                                            ...
                                            <!-- Active HoldLock Users -->
                                            <div class="wallet-card wallet-green">
                                                <div class="wallet-card-header">Active HoldLock Users</div>
                                ...
                                <div class="mb-32">
                                    <div class="d-flex justify-between items-center mb-16">
                                        <h5 class="label-01">HoldLock Plans</h5>
                                ...
                                <div class="mb-32">
                                    <h5 class="label-01 mb-16">Active HoldLock Savings</h5>
                                    <div class="table-list-transaction">
                                        <div class="list-transaction-head title-sort bg-Primary">
                ...
                <!-- Add/Edit HoldLock Plan Modal -->
                <div class="modal" id="holdlock-plan-modal">
                    <div class="modal-overlay"></div>
                    <div class="modal-content" style="max-width: 600px;">
                        <div class="modal-header">
                            <h2 id="holdlock-plan-title">Add HoldLock Plan</h2>
