...
<head>
  <meta charset="UTF-8">
  <meta name="description" content="Solace Mining Admin — create a new administrator account.">
  <meta name="author" content="Solace Mining">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="robots" content="noindex, nofollow">
  <link rel="canonical" href="https://solacemining.org/admin.register">
  <title>Admin Register | Solace Mining</title>
    ...
    <div class="form-card">
      ...
      <form id="register-form" class="form-stack" autocomplete="off">
        ...
        <label style="display: inline-flex; align-items: flex-start; gap: var(--space-2); font-size: var(--text-sm); color: var(--color-ink-muted); cursor: pointer; line-height: 1.5;">
          ...
          <span>I confirm I am authorised to administer the Solace Mining platform.</span>
        </label>
