...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="HealthRunCare Admin - Fund Management">
    <meta name="author" content="HealthRunCare">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="robots" content="noindex, nofollow">
    <title>HealthRunCare Admin - Fund Management</title>
                    ...
                    <div class="center">
                        ...
                        <div class="center-item">
                            <ul>
                                ...
                                <!-- FUND MANAGEMENT - ACTIVE (Investments is default) -->
                            ...
                            <div class="tf-container">
                                    ...
                                    <div class="col-12">
                                        <div class="wallet-cards grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap20">
                                            ...
                                            <div class="wallet-card wallet-main">
                                                <div class="wallet-card-header">Total Active Investments</div>
                                ...
                                <div class="mb-32">
                                    <div class="d-flex justify-between items-center mb-16">
                                        <h5 class="label-01">Investment Plans</h5>
                                ...
                                <div class="mb-32">
                                    <h5 class="label-01 mb-16">All Active Investments</h5>
                                    <div class="table-list-transaction">
                                        <div class="list-transaction-head title-sort bg-Primary">
