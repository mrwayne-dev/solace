...
<head>
  <meta charset="UTF-8">
  <meta name="description" content="Solace Mining Admin — reset your administrator password.">
  <meta name="author" content="Solace Mining">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="robots" content="noindex, nofollow">
  <link rel="canonical" href="https://solacemining.org/admin.forgotpassword">
  <title>Admin Password Reset | Solace Mining</title>
    ...
    <div class="form-card">
      ...
      <form id="forgot-step1" class="form-stack" autocomplete="off">
        <div class="form-field">
          ...
          <input id="forgot-email" type="email" class="form-field__input" placeholder="admin@solacemining.org" required>
        </div>
