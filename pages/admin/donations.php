...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="HealthRunCare Admin - Donations & Charity Campaigns">
    <meta name="author" content="HealthRunCare">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="robots" content="noindex, nofollow">
    <title>HealthRunCare Admin - Donations</title>
                        ...
                        <div class="center-item">
                            <ul>
                                ...
                                <li class="menu-item active">
                                    <a href="/admin.donations" class="menu-item-button active">
                            ...
                            <div class="tf-container">
                                ...
                                <div class="mb-32">
                                    <div class="d-flex justify-between items-center mb-16">
                                        <h5 class="f16-bold">Charity Campaigns</h5>
                                        <button id="add-campaign-btn" class="tf-button bg-Primary text-White f12-bold   ">
                                            <span class="iconify" data-icon="mdi:plus"></span> Add Campaign
                                        </button>
                                    </div>

                                    <!-- Search + Filter -->
                                    <div class="topbar-search mb-20">
                                        <form class="form-search flex-grow">
                                            <fieldset class="name">
                                                <input type="text" id="campaign-search" placeholder="Search campaigns..." class="show-search style-1">
                                            </fieldset>
                                    ...
                                    <div class="table-list-transaction">
                                        <div class="list-transaction-head title-sort bg-Primary">
                                            ...
                                            <div class="f12-bold text-White">Goal</div>
                                            <div class="f12-bold text-White">Raised</div>
                                ...
                                <!-- 3. ALL DONATIONS LIST -->
                                <div class="mb-32">
                                    <div class="d-flex justify-between items-center mb-16">
                                        <h5 class="f16-bold">Donation History</h5>
                                        <a href="#" id="export-donations-csv" class="tf-button style-2 f12-bold">
                                            <span class="iconify" data-icon="mdi:file-export"></span> Export CSV
                                        </a>
                                    </div>
                                    ...
                                    <div class="topbar-search mb-20">
                                        <form class="form-search flex-grow">
                                            <fieldset class="name">
                                                <input type="text" id="donation-search" placeholder="Search donor, campaign..." class="show-search style-1">
                                            </fieldset>
                                            <div class="button-submit">
                                                <button type="submit"><i class="icon-search-normal1"></i></button>
                                            </div>
                                    ...
                                    <div class="table-list-transaction">
                                        <div class="list-transaction-head title-sort bg-Primary">
                                            <div class="f12-bold text-White">Donor</div>
                                            <div class="f12-bold text-White">Campaign</div>
                                    ...
                                    <!-- Pagination -->
                                    <div id="donations-pagination" class="pagination mt-3 flex gap-2 justify-center"></div>
                                </div>
                        ...
                        <div class="modal-body">
                            <form id="campaign-form">
                                ...
                                <div class="form-group mb-3">
                                    <label>Campaign Name <span class="text-Red">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label>Goal Amount (USD) <span class="text-Red">*</span></label>
                                            <input type="number" step="0.01" class="form-control" id="campaign-goal" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label>Raised Amount (USD)</label>
                                            <input type="number" step="0.01" class="form-control" id="campaign-raised" value="0">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                    <label>Campaign Image</label>
                                    <input type="file" class="form-control" id="campaign-image" accept="image/*">
                                    <div class="mt-2">
                                        <img id="current-image-preview" src="" alt="Current" class="img-thumbnail" style="max-height: 100px; display: none;">
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                    <label>Status</label>
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="modal-confirm-btn">Save Campaign</button>
                                </div>
                            </form>
                        </div>
                    </div>
